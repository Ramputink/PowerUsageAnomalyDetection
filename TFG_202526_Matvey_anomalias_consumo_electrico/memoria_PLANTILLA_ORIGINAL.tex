...
\begin{titlepage}
	...
	\begin{center}
		...
		\end{Large}
		 	{\Huge Implementación de un sistema de detección de anomalías de consumo eléctrico}\\
		 	\vspace*{0.5cm}
	 		\rule{10.5cm}{0.1mm}\\
			\vspace*{0.9cm}
...
dfvhzidufnvzsdyfzsndfsdfysng

\textbf{aeafaysefnius}

\section{Sección 1}

\paragraph{dfzvysdvynv}


\chapter{State of the Art}

\section{Context and Motivation of the Energy Problem}

Buildings account for more than 40\% of global energy consumption and over 30\% of carbon dioxide emissions \cite{Himeur2021}. In this context, the European Union has strengthened its regulatory framework through Directive (EU) 2024/1275 on the energy performance of buildings (EPBD), which establishes objectives such as achieving zero-emission buildings by 2030 and progressively reducing the energy consumption of the existing building stock \cite{EPBD2024}.

As a consequence of widespread digitization, the traditional power grid has evolved by integrating more optimized and intelligent systems. Incorporation of high-frequency and high-precision sensors, such as smart meters, enables the collection of more structured and detailed energy consumption data. By leveraging these technologies, advanced systems are developed through the integration of sensing devices, communication networks, and software platforms. These devices integrate into the Advanced Metering Infrastructure (AMI); as a result, the power distribution grid is no longer a purely physical infrastructure, but it evolves into a cyber-physical system\cite{Ahmad2025}. 

\section{Conjuntos de datos de consumo eléctrico}
